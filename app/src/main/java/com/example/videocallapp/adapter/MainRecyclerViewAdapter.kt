package com.example.videocallapp.adapter
...
import com.example.videocallapp.databinding.ItemPhoneBookBinding
...
class MainRecyclerViewAdapter(private val listener: Listener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainRecyclerViewHolder {
        val binding = ItemPhoneBookBinding.inflate(
    ...
    class MainRecyclerViewHolder(private val binding: ItemPhoneBookBinding) :
            ...
            binding.apply {
                when (user.second) {
                    "ONLINE" -> {
                        ...
                        statusTv.setTextColor(context.resources.getColor(R.color.green, null))
